    ...
    <Topbar
      ...
      center={
        <button
          ...
          className="flex h-7 w-full max-w-80 items-center gap-2 rounded-md border border-border bg-bg-subtle px-2.5 text-caption text-text-muted transition-colors duration-150 hover:bg-surface-hover"
        >
        ...
        <>
          <Tooltip content={t('sidebar.notifications')}>
            <Link
              ...
              className="relative flex size-8 items-center justify-center rounded-md text-text-muted transition-colors duration-150 hover:bg-surface-hover hover:text-text"
            >
